...
天空分布提供 Mollweide 等面积全天图、赤道／银道坐标切换、银道、月度时长着色、缩放平移和联动源列表。浅绿色填充站址的「可观测天区」：以 J2000 目录赤纬作静态近似，表示每日过境时满足天顶角限制的总范围，随台站纬度及天顶角上限变化。经度影响过境时刻，不改变这一全天范围；固定赤纬边界在赤道 Mollweide 中是水平线，切换银道坐标后通常呈曲线。蓝色填充当前预览源周围的球面视场，半径可调，支持放大和查看视场内源中心。二者顶部保留独立开关，色块统一放在下方图例，仅显示已开启的图层；均不代表已经满足指定夜晚的暗夜和日月条件。单夜计算包含岁差与章动，边界附近可能略有差异。悬停查看信息，点击源进入单夜；列表可定位目标。视图菜单保留「经典坐标图 · 1.0」。月度颜色固定在 0–240 h（更高值封顶），确切时长见源卡片；灰色表示尚未计算，不能当作零。亮星的上下两张单夜天图各有独立开关，关闭邻近图亮星时同时隐藏恒星明细。
