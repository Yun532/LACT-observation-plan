...
2. 选择一个源和月份，查看逐日窗口，再进入指定夜晚。也可直接进入单夜工作台，点击输入框旁的「选择当晚源」，按所选夜晚的可观测时长从长到短浏览源及分段窗口，筛选目录、名称和状态，直接叠加或移除轨迹。列表与轨迹采用相同的 1 分钟采样及观测条件，时长未扣除已排任务。单夜工作台同时显示天顶角、月距、可观测时段、天顶角分布及附近 5° 的目录条目。
